...
class TestActivityView(TestCase):
    ...
    def test_student_cannot_change_activities(self):
        # create student user
        self.client.post("/api/accounts/", self.student1_data, format="json")
        ...
        # create activity
        self.client.post("/api/activities/", self.activity_data, format="json")

        # student try updates activity
        response = self.client.put(
            "/api/activities/",
            {"id": 1, "grade": 90},
            format="json",
    ...
    def test_student_cannot_create_two_activities_with_the_same_repo(self):
        # create student user
        self.client.post("/api/accounts/", self.student1_data, format="json")
        ...
        # create activity 1 with the repo: repo test
        self.client.post("/api/activities/", self.activity_data_1, format="json")

        # create activity 2 with the repo: repo test
        response = self.client.post(
